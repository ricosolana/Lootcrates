...
public class Lang {
    ...
    public static String CONFIG_REWARDS_REPORT = "Please report this at %s";
    public static String CONFIG_REWARDS_SUCCESS = "Successfully loaded rewards.yml";
    public static String CONFIG_SAVING_DEFAULT = "Saving default %s";
    public static String COMMAND_GIVE_SELF = "Gave yourself 1 %s crate";
    public static String EDITOR_ITEM_SET = "&eSet item by name";
    public static String SKRIPT_ERROR1 = "Unable to init Skript addons";
    public static String EDITOR_FORMATTING = "&7&lSpecial formatting";
    public static String CONFIG_ERROR11 = "Error loading player stats: %s";
    public static String CONFIG_ERROR10 = "Error saving player stats: %s";
