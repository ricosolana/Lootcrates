...
public class PlayerLog {
    ...
    public static void saveAll(@Nonnull CommandSender sender) {
        try {
            ...
            LCMain.get().notifier.severe(sender, String.format(Lang.MESSAGE_STATS_ERROR10, e.getMessage()));
        }
    }
    ...
    public static void loadAll(@Nonnull CommandSender sender) {
        try {
            ...
            LCMain.get().notifier.severe(sender, String.format(Lang.MESSAGE_STATS_ERROR11, e.getMessage()));
        }
    }
