...
class CmdArg {
     ...
     *  arg passing
     */
    static Map<String, CmdArg> args =
            ImmutableMap.of(
                    "save", new CmdArg((sender, args) -> {
                        plugin.saveConfig();
                        return feedback(sender, "Saved config to disk");
                    }, null),
                    "crate", new CmdArg((sender, args) -> {
                    ...
                    "version", new CmdArg((sender, args) -> feedback(sender, "LootCrates version: " + plugin.getDescription().getVersion()), null),
                    "detect", new CmdArg((sender, args) -> {
                        if (!(sender instanceof Player))
